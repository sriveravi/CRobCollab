...
% datFldr = '/media/New_Volume/CRSameDiffProj/ChrisData/EyeTrackingWordCondition/UnimodalVisual/AllASC/';
% cond = 'WordVis';

datFldr = '../ChrisData/NewYoungAdults/Visual/AllASC/';
cond = 'AdultYoungerVis';
