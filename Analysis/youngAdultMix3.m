...
% datFldr = '/media/New_Volume/CRSameDiffProj/ChrisData/EyeTrackingWordCondition/CrossModal/AllASC/';
% cond = 'WordMix';

datFldr = '../ChrisData/NewYoungAdults/CrossModal/AllASC/';
cond = 'AdultYoungerCross';
