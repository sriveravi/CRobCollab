...
[height ] = imSize(2);
% imFolder = '../ExpBasic/';
imFolder = '../ChrisData/EyeTracking/Stimuli/CenteredImg/';
aoiFolder = '../ChrisData/EyeTracking/Stimuli/CenteredImg/Annotations/';
maxDist = 70;
...
% datFldr = '/media/New_Volume/CRSameDiffProj/ChrisData/EyeTrackingWordCondition/UnimodalWords/AllASC/';
% cond = 'Word';

datFldr = '../ChrisData/NewYoungAdults/Auditory/AllASC/';
cond = 'AdultYoungerAud';
...
% %         stimSegment = trials;
        ...
        for i1 = 1:length( trials)
            ...
            %---- load AOI position, 
            imgStim = 'V6'; % stimSegment(i1).test_visual(1:end-4);  %test_visual(1:end-4); % get test stim name
