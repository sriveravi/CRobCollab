...
datFldr = '/media/New_Volume/CRSameDiffProj/ChrisData/NewSoundExperiment/auditory/AllASC/';
cond = 'NewSoundAud';
...
% %         stimSegment = trials;
        ...
        for i1 = 1:length( trials)
            ...
            %---- load AOI position, 
            imgStim = stimSegment(i1).test_visual(1:end-4);  %test_visual(1:end-4); % get test stim name
